...
$md5Str = "a";
$md5Str1 = "thisexampo@987";
// $pass = "TOPS";
$pass = "check@data444";
$md5Str2 = "aAAsdfgkjahdfgkhajdfgkjhasdkjg";

echo $md5Str1."<br>";  // use for the encription and its one way encription we cant decript it
echo md5("$md5Str1")."<br>";  // use for the encription and its one way encription we cant decript it
echo md5("adminkuchbhidata")."<br>";  // use for the encription and its one way encription we cant decript it
// echo md5("A")."<br>";  // use for the encription and its one way encription we cant decript it
// exit;
echo "base64_encode<br>".base64_encode($md5Str1)."<br>";
