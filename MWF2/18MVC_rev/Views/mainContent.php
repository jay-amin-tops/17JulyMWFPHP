            ...
            <div class="col-lg-6 about-imgs-txt">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 about-fashion-one">
                        <img src="<?php echo $this->dynamic_assets_url;?>images/ab1.jpg" alt="news image" class="img-fluid">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 about-fashion-two mt-lg-5 mt-md-4 mt-sm-3">
                        <img src="<?php echo $this->dynamic_assets_url;?>images/ab2.jpg" alt="news image" class="img-fluid">
                    </div>
                </div>
            </div>
    ...
    <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6">
                <img src="<?php echo $this->dynamic_assets_url;?>images/c1.jpg" alt="news image" class="img-fluid">
            </div>
        </div>
        <!--// row -->
        <!-- row -->
        <div class="row my-lg-5 my-md-4 my-3">
            <div class="col-lg-5 col-md-6">
                <img src="<?php echo $this->dynamic_assets_url;?>images/c2.jpg" alt="news image" class="img-fluid">
            </div>
            <div class="col-lg-7 col-md-6 collection-w3layouts">
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 about-fashion-one">
                        <img src="<?php echo $this->dynamic_assets_url;?>images/c3.jpg" alt="news image" class="img-fluid">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 about-fashion-two mt-lg-5 mt-md-4 mt-sm-3">
                        <img src="<?php echo $this->dynamic_assets_url;?>images/ab2.jpg" alt="news image" class="img-fluid">
                    </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 cilent-item text-center">
                <div class="mb-lg-4 mb-3 clients-ile-img">
                    <img src="<?php echo $this->dynamic_assets_url;?>images/cc2.jpg" alt=" " class="img-fluid">
                </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 cilent-item text-center">
                <div class="mb-lg-4 mb-3 clients-ile-img">
                    <img src="<?php echo $this->dynamic_assets_url;?>images/cc1.jpg" alt=" " class="img-fluid">
                </div>
                <div class="clients-color-ile text-center">
                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit
                        Lorem ipsum dolor sit amet, consectetuer adipiscing elit
