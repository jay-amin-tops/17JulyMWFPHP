...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<!--//tags -->
	<link href="<?php echo $this->base_url; ?>css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
	<link href="<?php echo $this->base_url; ?>css/style.css" rel="stylesheet" type="text/css" media="all" />
	<link href="<?php echo $this->base_url; ?>css/font-awesome.css" rel="stylesheet">
	<link href="<?php echo $this->base_url; ?>css/easy-responsive-tabs.css" rel='stylesheet' type='text/css' />
