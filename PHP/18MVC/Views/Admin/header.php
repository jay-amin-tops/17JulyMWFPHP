...
<head>
  ...
  <!-- Template CSS -->
  <link rel="stylesheet" href="<?php echo $this->base_url; ?>admin_assets/css/style-starter.css">
...
<section>
  ...
  <div class="sidebar-menu sticky-sidebar-menu">
    ...
    <!-- logo start -->
    <div class="logo">
      <h1><a href="admindahboard">Collective</a></h1>
    </div>

    <div class="logo-icon text-center">
      <a href="admindahboard" title="logo"><img src="<?php echo $this->base_url; ?>admin_assets/images/logo.png" alt="logo-icon"> </a>
    </div>
    ...
    <div class="sidebar-menu-inner">
      ...
      <ul class="nav nav-pills nav-stacked custom-nav">
        <li class="active"><a href="admindahboard"><i class="fa fa-tachometer"></i><span> Dashboard</span></a>
        </li>
        <li class="menu-list">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="#" class="grid">
                      <div class="user_img"><img src="<?php echo $this->base_url; ?>admin_assets/images/avatar1.jpg" alt=""></div>
                  ...
                  <li class="odd"><a href="#" class="grid">
                      <div class="user_img"><img src="<?php echo $this->base_url; ?>admin_assets/images/avatar2.jpg" alt=""></div>
                      <div class="notification_desc">
                  ...
                  <li><a href="#" class="grid">
                      <div class="user_img"><img src="<?php echo $this->base_url; ?>admin_assets/images/avatar3.jpg" alt=""></div>
                      <div class="notification_desc">
              ...
              <li class="dropdown profile_details_drop">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" id="dropdownMenu3" aria-haspopup="true"
                  ...
                  <div class="profile_img">
                    <img src="<?php echo $this->base_url; ?>admin_assets/images/profileimg.jpg" class="rounded-circle" alt="" />
